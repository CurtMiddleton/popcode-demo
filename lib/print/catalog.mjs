...
export const PRODUCTS = {
  ...
  /* 11oz photo mugs.
     ...
     ONE print area, which the API states exactly: a 228.6 x 94.83 mm wrap all
     the way round (aspect 2.41). So the photo is a panorama rather than a front
     panel, and there is nowhere to put the URL except in the artwork — `wrap`
     tells the builder to set it vertically at the trailing edge, beside the
     handle. (The coloured mugs never published a usable print area at all,
     which is why their wrap figure below is the product page's and not the
     API's; moot while they are hidden.)
