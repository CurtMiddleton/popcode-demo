...
export const PRODUCTS = {
  ...
  ornament: [
    { id: 'orn-alum-rect', label: 'Aluminium Ornament 4×3"', sku: 'XMAS-ALUM-RC',   aspect: 102 / 75, sizing: 'fillPrintArea', printArea: 'default', attributes: {}, minCopies: 3 },
    { id: 'orn-alum-sq',   label: 'Aluminium Ornament 3×3"', sku: 'XMAS-ALUM-SQ',   aspect: 1,        sizing: 'fillPrintArea', printArea: 'default', attributes: {}, minCopies: 3 },
    { id: 'orn-glass-sq',  label: 'Glass Ornament 3×3"',     sku: 'XMAS-GLASS-SQ',  aspect: 1,        sizing: 'fillPrintArea', printArea: 'default', attributes: {}, minCopies: 3 },
    { id: 'orn-ceramic',   label: 'Ceramic Ornament 3×3"',   sku: 'XMAS-PORC-BAUB', aspect: 1,        sizing: 'fillPrintArea', printArea: 'default', attributes: {}, minCopies: 3, round: true },
    { id: 'orn-bauble',    label: 'Christmas Bauble',        sku: 'XMAS-PLAS-BAUB', aspect: 79 / 84,  sizing: 'fillPrintArea', printArea: 'default', attributes: {}, minCopies: 3, round: true },
  ],
