...
export const PRODUCTS = {
  ...
  /* ── GIFT PRODUCTS (magnets, stickers, ornaments, mugs) ────────────────
     ...
     ⚠ SKUs BELOW ARE READ OFF PRODIGI'S PUBLIC PRODUCT PAGES, NOT THE API.
       Those pages label their tables "some example variants", and the
       kiss-cut page gives a prefix (GLOBAL-STI) that does not match the SKUs
       it then lists (M-STI-*). Verify every one before selling:
           PRODIGI_API_KEY=… node scripts/verify-prodigi-sku.mjs \
             MAG-1-10X10 MAG-1-15X15 M-STI-3X4 M-STI-5_5X5_5 M-STI-8_5X8_5 \
             M-STI-14X14 XMAS-ALUM-RC XMAS-ALUM-SQ XMAS-GLASS-SQ \
             XMAS-PORC-BAUB XMAS-PLAS-BAUB H-MUG-11OZ-BLA H-MUG-11OZ-RED \
             H-MUG-11OZ-YLW H-MUG-11OZ-PNK H-MUG-11OZ-LIGR
       It reports each SKU's real print areas and attributes, and a SKU that
       declares more required print areas than we supply assets for fails with
       MissingRequiredAssets. Then price them for real:
  ...
  // Kiss-cut vinyl stickers. `aspect` is the PRINT AREA, not the backing sheet
  // (66.9×95.3 mm of art on a 76×102 mm sheet), because fillPrintArea fits the
  // asset to the print area and cropping to the sheet would distort it.
  //
  // Prodigi asks for PNG at 300 DPI with 2.5 mm of padding, and — unusually —
  // imposes a MAXIMUM pixel size as well as a minimum. Both live in `asset`.
  sticker: [
    { id: 'sti-3x4',   label: 'Sticker 3×4"',     sku: 'M-STI-3X4',     aspect: 66.9 / 95.3, sizing: 'fillPrintArea', printArea: 'default', attributes: {}, minCopies: 3, asset: { format: 'png', paddingMm: 2.5, maxPx: { w: 900, h: 1200 } } },
    { id: 'sti-5_5',   label: 'Sticker 5.5×5.5"', sku: 'M-STI-5_5X5_5', aspect: 1,           sizing: 'fillPrintArea', printArea: 'default', attributes: {}, minCopies: 3, asset: { format: 'png', paddingMm: 2.5, maxPx: { w: 1650, h: 1650 } } },
    { id: 'sti-8_5',   label: 'Sticker 8.5×8.5"', sku: 'M-STI-8_5X8_5', aspect: 1,           sizing: 'fillPrintArea', printArea: 'default', attributes: {}, minCopies: 3, asset: { format: 'png', paddingMm: 2.5, maxPx: { w: 2475, h: 2475 } } },
    { id: 'sti-14',    label: 'Sticker 14×14"',   sku: 'M-STI-14X14',   aspect: 1,           sizing: 'fillPrintArea', printArea: 'default', attributes: {}, minCopies: 3, asset: { format: 'png', paddingMm: 2.5, maxPx: { w: 4125, h: 4125 } } },
  ],
