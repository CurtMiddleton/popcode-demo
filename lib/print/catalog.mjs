...
export const PRODUCTS = {
  print: [
    { id: 'fap-10x10', label: 'Fine Art Print 10×10"',    sku: 'GLOBAL-FAP-10x10', sizing: 'fillPrintArea', printArea: 'default', attributes: {} },
    { id: 'fap-16x24', label: 'Fine Art Print 16×24"',    sku: 'GLOBAL-FAP-16x24', sizing: 'fillPrintArea', printArea: 'default', attributes: {} },
  ],
  tile: [
    { id: 'tile-5x7',  label: 'Framed Photo Tile 5×7"',   sku: 'PHOTIL-FRA-0507',  sizing: 'fillPrintArea', printArea: 'default', attributes: {} },
    { id: 'tile-8x8',  label: 'Framed Photo Tile 8×8"',   sku: 'PHOTIL-FRA-0808',  sizing: 'fillPrintArea', printArea: 'default', attributes: {} },
    { id: 'tile-8x10', label: 'Framed Photo Tile 8×10"',  sku: 'PHOTIL-FRA-0810',  sizing: 'fillPrintArea', printArea: 'default', attributes: {} },
  ],
};
