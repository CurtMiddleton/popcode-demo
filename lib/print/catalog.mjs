...
export const PRODUCTS = {
  ...
  tile: [
    { id: 'tile-5x7',  label: 'Framed Photo Tile 5×7"',   sku: 'PHOTIL-FRA-0507',  aspect: 5 / 7,   sizing: 'fillPrintArea', printArea: 'default', attributes: {} },
    { id: 'tile-8x8',  label: 'Framed Photo Tile 8×8"',   sku: 'PHOTIL-FRA-0808',  aspect: 1,       sizing: 'fillPrintArea', printArea: 'default', attributes: {} },
    { id: 'tile-8x10', label: 'Framed Photo Tile 8×10"',  sku: 'PHOTIL-FRA-0810',  aspect: 8 / 10,  sizing: 'fillPrintArea', printArea: 'default', attributes: {} },
  ],
