...
export const COMPANION_CARD = {
  ...
  // ON as of 2026-09-14, the SKU having been verified against Prodigi's
  // catalogue. Note what this flag protects: the companion joins the SAME
  // Prodigi quote as the rest of the cart, so anything Prodigi rejects about it
  // fails the quote for the WHOLE order — taking checkout down, not just the
  // card. Set it back to false to disable the card without touching anything
  // else.
  enabled: true,
