...
export const PRODUCTS = {
  ...
  /* 11oz photo mugs.
     ...
     ONE print area: a 229 x 95 mm wrap all the way round (aspect 2.41), so the
     photo is a panorama rather than a front panel and there is nowhere to put
     the URL except in the artwork. `wrap` tells the builder to set it
     vertically at the trailing edge, beside the handle.
  ...
  mug: [
    { id: 'mug-11oz', label: '11oz Photo Mug', sku: 'GLOBAL-MUG-W', aspect: 229 / 95, sizing: 'fillPrintArea', printArea: 'default', attributes: {}, minCopies: 1, wrap: { widthMm: 229, heightMm: 95, safeMm: 4 }, asset: { format: 'jpeg', dpi: 300 } },
