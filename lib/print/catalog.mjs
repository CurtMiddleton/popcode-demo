...
export const PRODUCTS = {
  ...
  book: [
    ...
    { id: 'book-21sq-layflat', label: 'Layflat Photo Book — 8×8" Square', sku: 'BOOK-FE-21X21-SQ-LF-G', isBook: true, sizing: 'fillPrintArea', printArea: 'default', attributes: {}, minPages: 24, maxPages: 122, hidden: true },
  ],
