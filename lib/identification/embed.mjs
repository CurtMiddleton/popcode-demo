...
// transformers.js is dynamically imported the first time we actually embed, so
// importing this module (e.g. from the /api/identify request path, which only
// ever receives a precomputed embedding) does NOT pull the ~MBs of ML runtime
