...
(generated from ISO 3166-1) and is shared by `order.html`, `book.html` and
`calendar.html` via `popcodeFillCountrySelect()`. Uninhabited territories and
comprehensively sanctioned countries are excluded.
